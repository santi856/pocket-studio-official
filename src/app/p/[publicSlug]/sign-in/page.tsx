...
import { signInPublishedAppUserAction } from "@/lib/actions/publish-app-auth-actions";

export default async function PublishedAppSignInPage({
  params,
  searchParams,
}: {
  ...
  const action = signInPublishedAppUserAction.bind(null, publicSlug);
