...
import { signUpPublishedAppUserAction } from "@/lib/actions/publish-app-auth-actions";

/**
 * Real, unauthenticated sign-up for a published generated app's own end
 * customer — mirrors src/app/org/[orgSlug]/[projectSlug]/app/sign-up
 * exactly, resolved via the public publication slug instead of an
 * org/project slug pair.
 */
export default async function PublishedAppSignUpPage({
  params,
  searchParams,
}: {
  ...
  const action = signUpPublishedAppUserAction.bind(null, publicSlug);
